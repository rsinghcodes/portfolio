...
const Skills = () => {
  return (
    ...
    >
      ...
      <div className="flex flex-row justify-start items-center m-0 p-0 before:block before:w-[1px] before:h-[230px] before:md:h-[180px] before:my-0 before:mr-8 before:bg-slate-600">
